...
SYSROOT_PKG=/home/herrie/webos/$QT_FOLDER_PREFIX$QT_VERSION_MAJOR/$FOLDER_PREFIX$QT_VERSION_MAJOR.$QT_VERSION_MINOR/device/sysroot
...
MY_PREFIX=/home/herrie/webos/$QT_FOLDER_PREFIX$QT_VERSION_MAJOR/$QT_FOLDER_PREFIX$QT_VERSION_MAJOR.$QT_VERSION_MINOR/runtime
WEBOS_PREFIX=/media/cryptofs/apps/usr/palm/applications/com.nizovn.qt5

#disabled below for now, since this doesn't seem to work
